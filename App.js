        ...
        <Tooltip
            popover={
                <Text style={{ color: colors.white }}>
                    Colour statuses are for guidance only. They predict likely crowding of promenade
                    and beach area today based on CCTV, social events, weather patterns and
                    observation. Information is updated by the Seafront Team between 11am and 5pm.
                </Text>
            }
            backgroundColor={colors.blueTutton}
            width={300}
