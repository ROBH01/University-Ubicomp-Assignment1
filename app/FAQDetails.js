...
const FAQs = [
  ...
  {
    id: "1",
    question: "How do I set up a contract for commercial waste collections?",
    answer:
      "Simply get in touch with us and we’ll arrange for one of our team to visit you to assess your needs.",
  },
  {
    id: "2",
    question: "How soon can you start collecting my commercial waste?",
    answer:
      "Once one of our team has visited you and you’ve decided on the appropriate bin size and collection frequency, we will normally provide bins within five days. Your business will then be added to our next scheduled collection day. If you have a build-up of waste and require a collection sooner, please contact us.",
  },
  {
    id: "3",
    question: "When will my commercial waste be collected?",
    answer:
  ...
  {
    id: "6",
    question: "Can I arrange for you to visit outside of normal office hours?",
    answer:
  ...
  {
    id: "8",
    question: "How regularly do you invoice and can I pay by Direct Debit?",
    answer:
      "We invoice yearly in advance. We offer Direct Debit instalment plans, all covered by the Direct Debit Guarantee. ",
  },
  {
    id: "9",
    question: "Can I take my waste or recycling home and put it in my bin?",
    answer: "No, passing commercial waste off as domestic waste is illegal.",
  },
];
